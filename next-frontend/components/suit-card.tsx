    ...
    <>
      <article className="border-b border-border p-4 hover:bg-muted/30 transition-colors cursor-pointer group relative">
        <div className="flex gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1 text-sm flex-wrap">
                ...
                <span className="text-muted-foreground hover:underline">{formatTime(timestamp)}</span>
                {isNFT && (
                    ...
                    {isNFT && (
                      <>
                        <div className="pb-3 border-b border-border">
                          <div className="text-xs text-muted-foreground mb-1">Suit Value</div>
                          <div className="text-lg font-bold text-foreground">{nftValue} SUI</div>
                          {currentBid > nftValue && (
          ...
          {/* Content */}
          <p className="mt-2 text-base text-foreground break-words">{content}</p>
